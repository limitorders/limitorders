...
function testPrice(price) {
  console.log("------------")
  console.log("origin ", price)
  console.log("encdec ", unpackPrice(packPrice(price)))
}

function test() {
  testPrice(2.8147497671065605e-12)
  testPrice(1.2933193792219687e-11)
  testPrice(1.2943193792219687e-11)
  testPrice(0.12)
  testPrice(1.2)
  testPrice(12)
